...
class FormsController extends Controller
{
    ...
    public function uploadFile(Request $request)
    {
        ...
        $uploader->newFileName = pathinfo($request->file('uploadfile')->getClientOriginalName(), PATHINFO_FILENAME) . '_' . time() . '.' . $ext;
    ...
    public function store(Request $request, $link)
    {
        ...
        $profile = Profile::create([
            ...
            'photo_url' => $photo_url ?? url('/') . '/uploads/profiles/photos/default.jpg'
        ]);
